...
APPNAME=mtb-psoc6-bgt60-grass-detector
...
#		ARM_MATH_LOOPUNROLL
DEFINES=CY_RETARGET_IO_CONVERT_LF_TO_CRLF CY_RTOS_AWARE \
        ARM_ALL_FFT_TABLES ARM_FAST_ALLOW_TABLES ARM_FFT_ALLOW_TABLES \
        ARM_TABLE_TWIDDLECOEF_F32_128 ARM_TABLE_BITREVIDX_FLT_128 \
        ARM_TABLE_TWIDDLECOEF_F32_64 ARM_TABLE_BITREVIDX_FLT_64 \
        ARM_TABLE_TWIDDLECOEF_RFFT_F32_128 ARM_ALL_FAST_TABLES \
		ARM_MATH_LOOPUNROLL \
		DISABLEFLOAT16
#DEFINES+=INFERENCE_TVM
...
# above.
#$(info $(shell pwd))
MODEL_NAME:=$(shell python get_name.py)
N_CLASSES:=$(shell python get_n_classes.py)
LABELSMAP:=$(shell python get_labels.py)
$(info Loading: $(MODEL_NAME))
$(info Number of classes: $(N_CLASSES))
$(info Labels: $(LABELSMAP))
CFLAGS=-D TVM_WORKSPACE_SIZE_BYTES=1024 \
       -D WINDOW_SIZE=10 \
       -D NUM_CLASSES=$(N_CLASSES) \
#       -D MODEL_NAME=$(MODEL_NAME) \
#       -D LABELS=$(LABELSMAP) \
#	   -D NUM_CLASSES=2 \
#	   -D UART_BUFFER_SIZE=50 \
#	   -D UART_BAUDRATE=57600
